    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                responsibleItems: [
                    ...
                    {value: 1, text: 'Marcelo'},
                    {value: 2, text: 'Schneider'},
                    {value: 3, text: 'Fialho'},
                    {value: 4, text: 'Marcelo Schneider'},
                    {value: 5, text: 'Marcelo Fialho'},
        ...
        methods: {
            ...
            loadService() {
                ...
                this.serviceResource().then((response) => {

                    let service  = response.data.solicitacao;

                    this.code = service.codigo;

                    this.responsible = service.responsavel_id;

                    this.local = service.local_id;

                    this.observation = service.descricao;
            ...
            serviceResource() {
                ...
                return this.$http.get('manutencao/show/' + this.$route.params.id);
